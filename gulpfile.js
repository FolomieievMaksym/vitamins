...
// Обработка html
function html() {
	return gulp.src([paths.html.app, '!' + paths.html.new, '!' + paths.html.components])
...
// Обработка scss
function scss() {
	return gulp.src([paths.scss.app, '!' + 'app/scss/**/*.min.scss'])
...
// Обработка js
function js() {
	return gulp.src([paths.js.app, '!' + 'app/js/**/*.min.js'])
		// .pipe(babel({
...
// Обработка images
function img() {
	return gulp.src(paths.images.app.img)
...
function fonts() {
	return gulp.src(paths.fonts.otf)
		.pipe(fonter({
			formats: ['ttf']
		}))
